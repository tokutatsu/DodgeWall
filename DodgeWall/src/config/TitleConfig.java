...
public class TitleConfig {
	...
	public static final Point startButtonPoint = new Point(WindowConfig.Width/2-startButtonWidth/2, WindowConfig.Height*3/5);

	// rankingボタン
	public static final int rankingButtonWidth = startButtonWidth;
	public static final int rankingButtonHeight = startButtonHeight;
	public static final Point rankingButtonPoint = new Point(WindowConfig.Width/2-rankingButtonWidth/2, startButtonPoint.y+startButtonHeight+10);

	// exitボタン
	public static final int exitButtonWidth = startButtonWidth;
	public static final int exitButtonHeight = startButtonHeight;
	public static final Point exitButtonPoint = new Point(WindowConfig.Width/2-rankingButtonWidth/2, rankingButtonPoint.y+rankingButtonHeight+10);
